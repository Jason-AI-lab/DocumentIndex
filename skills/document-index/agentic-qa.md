---
name: "agentic-qa"
description: "Answer questions through iterative reasoning with confidence scoring. Use when you need direct answers to specific questions."
---
...
See [examples/agentic_qa_tutorial.py](examples/agentic_qa_tutorial.py) for a complete, runnable example demonstrating:
- Quick questions, thorough analysis, and multi-hop reasoning
- Confidence score interpretation and threshold tuning
- Batch questions and interactive Q&A patterns
- Reasoning trace analysis and debugging
