---
name: "provenance-extraction"
description: "Exhaustively scan entire documents to find ALL evidence for topics. Use for compliance, audits, or comprehensive research."
---
...
See [examples/provenance_patterns.py](examples/provenance_patterns.py) for a complete, runnable example demonstrating:
- Single-topic extraction and multi-category analysis
- Threshold tuning and summary generation
- Progress tracking and streaming extraction
